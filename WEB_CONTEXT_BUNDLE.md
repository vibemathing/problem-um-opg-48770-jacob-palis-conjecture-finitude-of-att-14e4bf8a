...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-48770-jacob-palis-conjecture-finitude-of-att-14e4bf8a-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-48770"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-48770-jacob-palis-conjecture-finitude-of-att-14e4bf8a-v1",
      "problem_contract_sha256": "18bd699ffebcd1d56ba4fc8083ec2329704311d3a34f31188b4f66257b01bb9b",
      "problem_id": "problem:um-opg-48770-jacob-palis-conjecture-finitude-of-att-14e4bf8a",
      "route_id": "route:um-opg-48770-jacob-palis-conjecture-finitude-of-att-14e4bf8a-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-48770-jacob-palis-conjecture-finitude-of-att-14e4bf8a-source-fidelity-01",
      "graph_id": "graph:um-opg-48770-jacob-palis-conjecture-finitude-of-att-14e4bf8a-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-48770-jacob-palis-conjecture-finitude-of-att-14e4bf8a-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-48770-jacob-palis-conjecture-finitude-of-att-14e4bf8a-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture Let $Diff^{r}(M)$ be the space of $C^{r}$ Diffeomorphisms on the connected, compact and boundaryles manifold M and $\\chi^{r}(M)$ the space of $C^{r}$ vector fields. There is a dense set $D\\subset Diff^{r}(M)$ ( $D\\subset \\chi^{r}(M)$ ) such that $\\forall f\\in D$ exhibit a finite number of attractor whose basins cover Lebesgue almost all ambient space $M$ This is a very Deep and Hard problem in Dynamical Systems. It present the dream of the dynamicist mathematicians."
          },
          "statement_sha256": "50469f6e60adaecf459e2458d03c6b50a3f01e62cad387d282705c03137e6700"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-48770-jacob-palis-conjecture-finitude-of-att-14e4bf8a-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-48770-jacob-palis-conjecture-finitude-of-att-14e4bf8a-root",
      "route_id": "route:um-opg-48770-jacob-palis-conjecture-finitude-of-att-14e4bf8a-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-48770-d2605601a23e",
        "url": "https://www.unsolvedmath.com/problems/OPG-48770"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
